...
def judge(xpos,ypos,left,right,bottom,top):
    if xpos<right and xpos>left and ypos<bottom and ypos>top:
        print('get')
        return True
    else:
        return False
...
while True:
    ...
    f2rect = f1.render_to(screen, (120,500), "查询优化器-逻辑查询优化", fgcolor=GOLD, size=25)
